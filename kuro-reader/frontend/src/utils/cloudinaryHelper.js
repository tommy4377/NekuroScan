 ...
 * @returns {string} - URL Cloudinary ottimizzato o originale
 */
 ...
 */
export function useCloudinaryImage(imageUrl, preset = 'mangaCover') {
 ...
 */
export function generateSrcSet(imageUrl, preset = 'mangaCover') {
