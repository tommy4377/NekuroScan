/**
 * NOTIFICATION CENTER - User notifications drawer
 * Manages and displays user notifications with mark as read functionality
 */

import { useState, useEffect } from 'react';
import {
  Box, VStack, HStack, Text, IconButton, Badge,
