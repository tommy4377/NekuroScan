/**
 * BANNED NOTICE - Rate limit notification modal
 * Shows countdown when user is temporarily banned for too many requests
 */

import { useEffect, useState } from 'react';
import {
  Modal, ModalOverlay, ModalContent, ModalHeader, ModalBody, ModalFooter,
  Button, Text, VStack, Icon, Badge, HStack, Progress
} from '@chakra-ui/react';
import { FaBan, FaClock, FaExclamationTriangle } from 'react-icons/fa';

// ========== TYPES ==========

type BanReason = 'rate-limit' | 'burst' | 'blacklisted';
    ...
    const interval = setInterval(() => {
      setCountdown(prev => {
        if (prev <= 1) {
          ...
          onClose();
          // Return to home instead of reload
